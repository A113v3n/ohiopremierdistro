...
class fitmas_accordion_Widget extends Widget_Base {
    ...
    public function get_title() {
        ...
        return esc_html__( 'Fitmas Faq', 'fitmascore' );
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'active_tab',
            [
                'label'        => esc_html__( 'Active ', 'fitmascore' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'fitmascore' ),
                'label_off'    => esc_html__( 'Hide', 'fitmascore' ),
                'return_value' => 'yes',
        ...
        ?>
            ...
            <div class="accordion-area accordion" id="faqAccordion">
                <?php $count = 0;foreach ( $settings['faq_list'] as $item ): $count++;
                    ...
                    ?>
                    <div class="accordion-card <?php echo esc_attr( $active ); ?>">
                        <div class="accordion-header" id="collapse-item-<?php echo esc_attr( $count ); ?>">
                            <button class="accordion-button <?php echo esc_attr( $collapsed ); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo esc_attr( $count ); ?>" aria-expanded="true" aria-controls="collapse-<?php echo esc_attr( $count ); ?>">
                                <?php echo esc_html($item['faq_title']); ?>
                            </button>
                        </div>
                        <div id="collapse-<?php echo esc_attr( $count ); ?>" class="accordion-collapse collapse <?php echo esc_attr( $show ); ?>" aria-labelledby="collapse-item-<?php echo esc_attr( $count ); ?>" data-bs-parent="#faqAccordion">
...
Plugin::instance()->widgets_manager->register( new fitmas_accordion_Widget );
